...
const testQueryParamInlineEnumQuerySchema = z.object({ "fields[catalog-item-bulk-create-job]": z.array(z.enum(["status", "created_at", "total_count", "completed_count", "failed_count", "completed_at", "errors", "expires_at"])).optional() }).default({"fields[catalog-item-bulk-create-job]":["created_at"]});
