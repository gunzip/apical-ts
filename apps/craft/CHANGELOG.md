...
- a654397: Generated `routes/`, `client/`, and `server/` outputs now use the
  Standard Schema validation contract instead of exposing Zod-specific parsing
  APIs.
  ...
  - Generated client parse errors and generated server validation errors no
    longer expose `ZodError`; they now expose `StandardSchemaValidationError`
  ...
  - Existing Zod-based schemas generated by Craft continue to work because Zod
    v4 implements the Standard Schema contract.
