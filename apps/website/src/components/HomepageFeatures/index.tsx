...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Each API operation becomes a standalone, typed function. Import only
        what you need with full tree-shaking support and crystal-clear
  ...
  },
  {
    ...
    description: (
      <>
        Built on Zod v4 for robust runtime validation. Catch API contract
        violations early with comprehensive schema validation and type
        inference.
      </>
    ),
  },
